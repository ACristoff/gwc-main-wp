...
function genesis_sample_woocommerce_css() {
	...
	$color_link   = get_theme_mod( 'genesis_sample_link_color', $appearance['default-colors']['primary'] );
	$color_accent = get_theme_mod( 'genesis_sample_accent_color', $appearance['default-colors']['primary'] );

	$woo_css = '';

	$woo_css .= ( $appearance['default-colors']['primary'] !== $color_link ) ? sprintf(
		'
	...
	$woo_css .= ( $appearance['default-colors']['primary'] !== $color_accent ) ? sprintf(
		'
